...
export default function About() {
  ...
  return (
    <div className='container my-5'>
      ...
      <button className="my-3 " onClick={darkMode}>Enable Dark style</button>
      <button className="my-3 mx-2" onClick={lightMode}>Enable light style</button>
